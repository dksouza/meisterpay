(function () {
    ...
    let API_BASE = "https://app.meisterpay.com.br";
    ...
    async function initUpsell() {
        const container = document.querySelector('[data-meisterpay-upsell]');
        if (!container) return;

        const strategyId = container.getAttribute('data-meisterpay-upsell');
        ...
        try {
            ...
            if (strategy.is_active === false) {
                console.log('meisterpay Upsell: Strategy is inactive, skipping...');
                ...
                if (declineBtn) {
                    ...
                    const pi = params.get('pi') || sessionStorage.getItem('meisterpay_last_pi');
            ...
            console.error('meisterpay Upsell Error:', err);
        }
    }
