...
function CheckoutFormContent({
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const countryCodePrefix = (formData.get("country_code") as string) || "+55";
    const postalCodeVal = ((formData.get("customer_postal_code") as string) || "").trim();
    const phonePrefixToCountry: Record<string, string> = {
      "+55": "BR", "+1": "US", "+351": "PT", "+34": "ES", "+52": "MX", "+44": "GB",
      "+49": "DE", "+33": "FR", "+39": "IT", "+61": "AU", "+81": "JP", "+86": "CN",
      "+7": "RU", "+91": "IN", "+54": "AR", "+56": "CL", "+57": "CO", "+51": "PE",
      "+58": "VE", "+598": "UY", "+595": "PY", "+591": "BO", "+593": "EC", "+506": "CR",
      "+507": "PA", "+502": "GT", "+503": "SV", "+504": "HN", "+505": "NI", "+53": "CU"
    };
    const derivedCountry = detectedCountry || phonePrefixToCountry[countryCodePrefix] || "US";

    const customerData = {
      name: formData.get("customer_name") as string,
      email: formData.get("customer_email") as string,
      phone: `${countryCodePrefix} ${formData.get("customer_phone")}`,
    };
    ...
    // ── PAYMENT: confirm with Stripe (with AVS address details) ──
    const { error, paymentIntent } = await stripe.confirmCardPayment(activeClientSecret, {
      payment_method: {
        ...
        billing_details: {
          ...
          address: {
            postal_code: postalCodeVal || undefined,
      ...
      {paymentRequest && (
        <div className="payment-wallet-section">
          ...
          <div className="payment-divider">
            ...
            <span className="payment-divider-text">{t.orPayWithCard || (lang === 'en' ? 'or pay with card' : lang === 'es' ? 'o paga con tarjeta' : lang === 'it' ? 'o paga com carta' : lang === 'fr' ? 'ou payer par carte' : 'ou pague com cartão')}</span>
            <span className="payment-divider-line" />
          </div>
        </div>
      )}
      ...
      <div className="form-section">
        ...
        <div className="phone-input-group">
          <select
            ...
            defaultValue={
              (detectedCountry && {
                BR: "+55", US: "+1", CA: "+1", PT: "+351", ES: "+34", MX: "+52", GB: "+44",
                DE: "+49", FR: "+33", IT: "+39", AU: "+61", JP: "+81", CN: "+86", RU: "+7",
                IN: "+91", AR: "+54", CL: "+56", CO: "+57", PE: "+51", VE: "+58", UY: "+598",
                PY: "+595", BO: "+591", EC: "+593", CR: "+506", PA: "+507", GT: "+502", SV: "+503",
                HN: "+504", NI: "+505", CU: "+53", DO: "+1809", HT: "+509", EG: "+20", ZA: "+27",
                NG: "+234", KE: "+254", MA: "+212", AE: "+971", SA: "+966", IL: "+972", TR: "+90",
                KR: "+82", TH: "+66", VN: "+84", ID: "+62", MY: "+60", PH: "+63", NZ: "+64"
              }[detectedCountry]) || "+1"
            }
          >
        ...
        <label className="checkout-form-label mt-4">{t.postalCode}</label>
        <input name="customer_postal_code" autoComplete="postal-code" type="text" className="checkout-input" placeholder={t.postalCodePlaceholder} required />
      </div>
                ...
                <div className="orderbump-content">
                  ...
                  <div className="orderbump-info">
                    ...
                    <p className="orderbump-price">
                      {new Intl.NumberFormat(lang === 'en' ? "en-US" : (lang === 'es' ? "es-ES" : (lang === 'it' ? "it-IT" : (lang === 'fr' ? "fr-FR" : "pt-BR"))), {
                        style: "currency",
