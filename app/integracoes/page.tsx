...
import { Layers, Puzzle, ShieldCheck, CheckCircle2, ChevronRight, Settings2, Webhook, Loader2, BookOpen, ExternalLink } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-3 items-start mb-8">
        ...
        <a
          href="https://docs.meisterpay.com.br/docs"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 group mt-1"
          style={{
        ...
        >
          <BookOpen size={16} className="text-purple-400 group-hover:scale-110 transition-transform" />
