    ...
    <div className="drawer-overlay" onClick={onClose}>
      <div className="drawer-container" onClick={(e) => e.stopPropagation()}>
        <div className="drawer-header">
          <h2 className="modal-title m-0">{initialData ? "Editar Produto" : "Criar Novo Produto"}</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
          <div className="drawer-body custom-scrollbar">
            ...
            <div className="form-group">
              <label className="form-label">ID do Produto Stripe</label>
              <input 
                name="stripe_product_id"
                type="text" 
                className="form-input" 
                placeholder="Ex: prod_..." 
                defaultValue={initialData?.stripe_product_id || ""}
              />
            </div>
